...
export default function ProductPage(){
    ...
    const itens = [{img_ulr:img_box,product_tittle:"CAIXA DE PAPELÃO - Para armazanagem de produtos - 25x UN - Embalagens",product_description:"Caixa grande para voce levar seus materiais em longas viagens",product_price:"56,93",product_id:1}]
